...
export class GameScene extends Phaser.Scene {
    ...
    createPlayers() {
        ...
        //this.players.push(this.createPlayer(700, 300, 'alienBeige', new GamepadController(2)));
        //this.players.push(this.createPlayer(900, 300, 'alienPink', new GamepadController(3)));
